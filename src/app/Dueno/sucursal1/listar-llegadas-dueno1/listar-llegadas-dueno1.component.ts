...
@Component({
  selector: 'app-listar-llegadas-dueno1',
  templateUrl: './listar-llegadas-dueno1.component.html',
  styleUrls: ['./listar-llegadas-dueno1.component.css']
})
export class ListarLlegadasDueno1Component implements OnInit {
