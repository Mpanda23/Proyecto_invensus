...
@Component({
  selector: 'app-lista-inventario-dueno',
  templateUrl: './lista-inventario-dueno.component.html',
  styleUrls: ['./lista-inventario-dueno.component.css']
})
export class ListaInventarioDuenoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    forkJoin([
      ...
      // Combinar los datos de los productos con las sumas
  ...
  obtenerValorMultiplicado(cantidadTotal: number, prodValor: any): number {
    if (typeof prodValor === 'number') {
      return cantidadTotal * prodValor;
    } else {
      console.error('El valor del producto no es un número:', prodValor);
      return 0;
    }
  }
