...
@Component({
  selector: 'app-listar-llegadas-dueno2',
  templateUrl: './listar-llegadas-dueno2.component.html',
  styleUrls: ['./listar-llegadas-dueno2.component.css']
})
export class ListarLlegadasDueno2Component {
