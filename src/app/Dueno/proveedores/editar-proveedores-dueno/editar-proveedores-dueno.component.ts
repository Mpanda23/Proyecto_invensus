...
@Component({
  selector: 'app-editar-proveedores-dueno',
  templateUrl: './editar-proveedores-dueno.component.html',
  styleUrls: ['./editar-proveedores-dueno.component.css']
})
export class EditarProveedoresDuenoComponent implements OnInit {
