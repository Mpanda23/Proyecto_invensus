...
@Component({
  selector: 'app-lista-productos-personal',
  templateUrl: './lista-productos-personal.component.html',
  styleUrls: ['./lista-productos-personal.component.css']
})
export class ListaProductosPersonalComponent implements OnInit {
