...
@Component({
  selector: 'app-anadir-sucursal2',
  templateUrl: './anadir-sucursal2.component.html',
  styleUrls: ['./anadir-sucursal2.component.css']
})
export class AnadirSucursal2Component implements OnInit {
