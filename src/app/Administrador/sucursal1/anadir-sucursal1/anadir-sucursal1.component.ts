...
@Component({
  selector: 'app-anadir-sucursal1',
  templateUrl: './anadir-sucursal1.component.html',
  styleUrls: ['./anadir-sucursal1.component.css']
})
export class AnadirSucursal1Component implements OnInit {
